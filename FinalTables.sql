...
score INT Not NULL,
CHECK (hr_response= 'Accepted' or hr_response='Rejected' or hr_response='Pending' ),-- as it can be only rejected accepted or waiting
CHECK (manager_response= 'Accepted' or manager_response='Rejected' or manager_response='Pending' ), -- as it can be only rejected, accepted  or waiting
CHECK(score>=0),
