...
namespace iWork
{
    ...
    public partial class Business_Request : System.Web.UI.Page
    {
        ...
        protected void applyForBusinessRequest(object sender, EventArgs e)
        {
            SqlConnection conn = new SqlConnection(connStr);

            SqlCommand cmd = new SqlCommand("Apply_For_Business_Request", conn);
            ...
            cmd.Parameters.Add(new SqlParameter("@destination", txt_destination.Text));
            cmd.Parameters.Add(new SqlParameter("@purpose", txt_purpose.Text));
